...
function LiveDemoChat() {
  ...
  const messages = [
    ...
    { role: 'ai', content: "Of course! Let's learn Binary Trees visually. Imagine a tree structure where each node has at most two children â€” left and right.", hasDiagram: true },
    ...
    { role: 'ai', content: "Great question! There are 3 main traversals:\n\n**In-order** (Left â†’ Root â†’ Right): 5, 10, 15\n**Pre-order** (Root â†’ Left â†’ Right): 10, 5, 15\n**Post-order** (Left â†’ Right â†’ Root): 5, 15, 10", hasCode: true },
    ...
    <div className="aurora min-h-screen">
      ...
      <nav className="fixed top-0 left-0 right-0 z-40">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src="/logo.web.png" alt="Academia AI" className="h-9 w-auto object-contain" />
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <EnterAppButton redirectUrl="/onboarding">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="section-subtitle">
              From uploading materials to AI-powered tutoring â€” Academia AI handles every aspect of your education.
            </p>
          </motion.div>
      ...
      {/* â”€â”€â”€â”€â”€â”€â”€â”€ Live Demo â”€â”€â”€â”€â”€â”€â”€â”€ */}
      ...
      <footer className="border-t border-white/5 px-6 py-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-sm text-white/30">
            <img src="/logo.web.png" alt="" className="h-4 w-auto object-contain" />
            Academia AI â€” Learning Operating System
          </div>
          <div className="flex items-center gap-6 text-sm text-white/30">
            <span>Â© 2026 Academia AI</span>
