...
async def generate_chapter_material(
    ...
    prompt = (
        ...
        "- Include at least 2 mermaid diagrams using fenced code blocks with the language "
        "tag ```mermaid . Use suitable diagram types: flowchart for processes and "
        "hierarchies, sequenceDiagram for interactions, mindmap for concept trees, "
        "classDiagram for structures, or gantt for timelines. Keep each diagram "
        "moderately sized (5-15 nodes) with clear, short labels.\n"
        "- Include at least 1 table (markdown table) comparing key concepts, formulas, or "
        "approaches.\n"
